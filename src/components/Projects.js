        ...
        <Grid sx={{
            ...
            <Grid xs={12}>
                    <h2 sx={{ fontSize: '1.5rem', marginBottom: 1 }}>
                        <a href="https://nikkitpt.github.io/chord-getter/" target="_blank" rel="noopener noreferrer">Chord Getter</a>
                    </h2>
                    ...
                    <p>
                        <a href="https://github.com/Nikkitpt/chord-getter"target="_blank" rel="noopener noreferrer">Github Repo</a>
                    </p>
                    <p>
                        <a href="https://nikkitpt.github.io/chord-getter/"target="_blank" rel="noopener noreferrer">Live Link</a>
                    </p>
                </Grid>

                <Grid xs={12}>
                    <h2 sx={{ fontSize: '1.5rem', marginBottom: 1 }}>
                        <a href="https://nikkitpt.github.io/DefiSciFi/"target="_blank" rel="noopener noreferrer">DefiScifi</a>
                    ...
                    <p>
                        <a href="https://github.com/Nikkitpt/DefiSciFi"target="_blank" rel="noopener noreferrer">Github Repo</a>
                    </p>
                    <p>
                        <a href="https://nikkitpt.github.io/DefiSciFi/"target="_blank" rel="noopener noreferrer">Live Link</a>
                    </p>
                </Grid>

                <Grid xs={12}>
                    <h2 sx={{ fontSize: '1.5rem', marginBottom: 1 }}>
                        <a href="https://nikkitpt.github.io/sampler/"target="_blank" rel="noopener noreferrer">Roland Sampler Clone</a>
                    ...
                    <p>
                        <a href="https://github.com/Nikkitpt/sampler"target="_blank" rel="noopener noreferrer">Github Repo</a>
                    </p>
                    <p>
                        <a href="https://nikkitpt.github.io/sampler/"target="_blank" rel="noopener noreferrer">Live Link</a>
                        {/* Live Link */}
                    </p>
                </Grid>
                <Grid xs={12}>
                    <h2 sx={{ fontSize: '1.5rem', marginBottom: 1 }}>
                        <a href="https://braveheartsmoveny.org"target="_blank" rel="noopener noreferrer">Nonprofit Website</a>
                    </h2>
                    <p sx={{ paddingBottom: '200px', flex: '1', fontSize: '2rem' }}>
                    ...
                    <p>
                        <a href="https://braveheartsmoveny.org"target="_blank" rel="noopener noreferrer">Live Link</a>
                    </p>
                </Grid>


            </Grid>
            <h1 sx={{ fontSize: '10rem', marginBottom: 2 }}>If you'd like to work together please shoot an email over to nicole.davis.nyc@gmail.com</h1>
        </Grid>
